...
public extension FrameworkToolbox where Base == String {
    var nsColor: NSColor {
        NSColor.box.fromHexString(hexString: base)
    }
}

public extension FrameworkToolbox where Base: NSColor {
    static func fromHexString(hexString: String) -> NSColor {
